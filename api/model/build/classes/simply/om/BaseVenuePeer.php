...
abstract class BaseVenuePeer {
	...
	const CLASS_DEFAULT = 'simply.Venue';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('id', 'name', 'address', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'address', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::ADDRESS, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'ADDRESS', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'address', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('id' => 0, 'name' => 1, 'address' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'address' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::ADDRESS => 2, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'ADDRESS' => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'address' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(VenuePeer::ID);
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = VenuePeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + VenuePeer::NUM_HYDRATE_COLUMNS;
		} else {
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(VenuePeer::ID) && $criteria->keyContainsValue(VenuePeer::ID) ) {
	...
	/**
	 * Performs an UPDATE on the database, given a Venue or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(VenuePeer::ID);
			$value = $criteria->remove(VenuePeer::ID);
			if ($value) {
				$selectCriteria->add(VenuePeer::ID, $value, $comparison);
			} else {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(VenuePeer::ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(VenuePeer::DATABASE_NAME);
			$criteria->add(VenuePeer::ID, $pks, Criteria::IN);
