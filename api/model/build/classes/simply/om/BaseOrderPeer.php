...
abstract class BaseOrderPeer {
	...
	const CLASS_DEFAULT = 'simply.Order';
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(OrderPeer::WHEN);
	...
	public static function doCountJoinPerformance(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(OrderPeer::PERFORMANCEID, PerformancePeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Order objects pre-filled with their Performance objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinPerformance(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Order) to $obj2 (Performance)
				$obj2->addPerformanceToOrder($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Order) to the collection in $obj2 (Performance)
				$obj2->addPerformanceToOrder($obj1);
