...
/**
 * Base static class for performing query and update operations on the 'ticketType' table.
 *
 * 
 *
...
abstract class BaseTicketTypePeer {
	...
	const CLASS_DEFAULT = 'simply.TicketType';
	...
	const PERFORMANCEID = 'ticketType.PERFORMANCEID';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('id', 'performanceId', 'name', 'price', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'performanceId', 'name', 'price', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::PERFORMANCEID, self::NAME, self::PRICE, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'PERFORMANCEID', 'NAME', 'PRICE', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'performanceId', 'name', 'price', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('id' => 0, 'performanceId' => 1, 'name' => 2, 'price' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'performanceId' => 1, 'name' => 2, 'price' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PERFORMANCEID => 1, self::NAME => 2, self::PRICE => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'PERFORMANCEID' => 1, 'NAME' => 2, 'PRICE' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'performanceId' => 1, 'name' => 2, 'price' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(TicketTypePeer::PERFORMANCEID);
			$criteria->addSelectColumn(TicketTypePeer::NAME);
			$criteria->addSelectColumn(TicketTypePeer::PRICE);
		} else {
	...
	/**
	 * Method to invalidate the instance pool of all tables related to ticketType
	...
	public static function doCountJoinPerformance(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(TicketTypePeer::PERFORMANCEID, PerformancePeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of TicketType objects pre-filled with their Performance objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of TicketType objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinPerformance(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		TicketTypePeer::addSelectColumns($criteria);
		$startcol = TicketTypePeer::NUM_HYDRATE_COLUMNS;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = TicketTypePeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = TicketTypePeer::getInstanceFromPool($key1))) {
				// We no longer rehydrate the object, since this can cause data loss.
				// See http://www.propelorm.org/ticket/509
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
				TicketTypePeer::addInstanceToPool($obj1, $key1);
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (TicketType) to $obj2 (Performance)
				$obj2->addPerformanceToTicketType($obj1);
	...
	/**
	 * Selects a collection of TicketType objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		TicketTypePeer::addSelectColumns($criteria);
		$startcol2 = TicketTypePeer::NUM_HYDRATE_COLUMNS;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (TicketType) to the collection in $obj2 (Performance)
				$obj2->addPerformanceToTicketType($obj1);
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(TicketTypePeer::ID);
			if ($value) {
				$selectCriteria->add(TicketTypePeer::ID, $value, $comparison);
			} else {
	...
	/**
	 * Deletes all rows from the ticketType table.
	 *
	 * @param      PropelPDO $con the connection to use
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
